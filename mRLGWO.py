...
def GWO(objf,lb,ub,dim,SearchAgents_no,Max_iter,trainInput,trainOutput,net):
    ...
    PositionsReplica = Positions.copy()
    # print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
    # print(len(Positions))
    print(Positions)
    ...
    # print(type(s))
     # Loop counter
    print("mRLGWO is optimizing  \""+objf.__name__+"\"")    
    ...
    for l in range(0,Max_iter):
        ...
        for i in range(0,SearchAgents_no):
            for j in range (0,dim):     
                ...
                PositionsReplica[i,j] = Positions[i,j]

                # Making oposite jump
                # X' = (a+b)/2 + (a+b)/2kn - X/kn

                # Positions[i,j] = (lb+ub)/2 + (lb+ub)/2kn - X/kn
                # Positions[i,j] = - Positions[i,j]/2.25 # k = n = 3/2
                # Positions[i,j] = - Positions[i,j]/6.25 # k = n = 5/2
                # Positions[i,j] = - Positions[i,j]/0.25 # k = n = 1/2
                Positions[i,j] = - Positions[i,j]*1000 # k =1/4, n = 1/2
